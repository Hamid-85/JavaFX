...
public class T3FX_HV1 extends Application {
	...
	public void start(Stage primaryStage) {
		...
		Label lblName = new Label("Lewis Hamilton");
		HBox hbName = new HBox(10, lbl1, lblName);
		hbName.setPadding(new Insets(5));

		Label lbl2 = new Label("Geb.");
		lbl2.setPrefWidth(100);
		Label lblborn = new Label("7 January 1985");
		HBox hbTeam = new HBox(10, lbl2, lblborn);
		...
		URI uri = Paths.get("C:\\Java\\Autos\\lewis-hamilton.jpg").toUri();
